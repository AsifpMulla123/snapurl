    ...
    <>
      ...
      <main className="relative overflow-hidden bg-[#f7f9fb] px-4">
        ...
        <div className="relative mx-auto max-w-3xl pt-20 pb-10 text-center">
          ...
          {!result && !error && (
            <p className="mt-3 text-sm text-[#5f6a6b]">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-14 grid grid-cols-1 gap-5 sm:grid-cols-3">
            ...
            <div className="rounded-2xl bg-white p-8 shadow-sm sm:col-span-2 sm:row-span-2">
              ...
              <div className="mt-2 flex justify-between text-xs text-[#5f6a6b]">
                <span>Mon</span>
                <span>Sun</span>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm">
              ...
              <div className="mt-5 flex flex-col gap-2">
                {[
                  ...
                  <div
                    key={r.label}
                    className="flex items-center gap-2 text-xs text-[#5f6a6b]"
                  >
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm sm:col-span-2">
              ...
              <p className="mt-2 text-xs text-[#5f6a6b]">
        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-14 overflow-hidden rounded-2xl border border-[#e0e3e5]">
            <div className="grid grid-cols-3 border-b border-[#e0e3e5] bg-[#f7f9fb]">
              <div className="px-6 py-4 text-sm text-[#5f6a6b]" />
              <div className="px-6 py-4 text-center">
                <span className="font-heading text-sm font-medium text-[#00685f]">
                  SnapURL
                </span>
              </div>
              <div className="px-6 py-4 text-center text-sm text-[#5f6a6b]">
                Typical shorteners
              </div>
            </div>
            ...
            {[
              ...
              >
                ...
                <div className="flex items-center justify-center px-6 py-4">
                  {row.them ? (
                    <Check className="h-5 w-5 text-[#5f6a6b]" />
                  ) : (
        ...
        <div className="mx-auto max-w-5xl">
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="mt-3 flex flex-col gap-2 text-sm text-[#5f6a6b]">
                <li>
          ...
          <div className="mt-12 border-t border-[#e0e3e5] pt-6 text-sm text-[#5f6a6b]">
